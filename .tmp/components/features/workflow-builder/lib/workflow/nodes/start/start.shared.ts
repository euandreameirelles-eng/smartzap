...
export const triggerTypeSchema = z.enum([
	"any_message",      // Qualquer mensagem inicia o fluxo
...
export const triggerConfigSchema = z.object({
	type: triggerTypeSchema.default("any_message"),
	keywords: z.array(z.string()).optional(),  // Para keyword, starts_with, contains
	pattern: z.string().optional(),             // Para regex
