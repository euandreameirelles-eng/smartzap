...
import { ConditionEditor } from "@/components/features/workflow-builder/components/editor/condition-editor";
import { BaseNode } from "@/components/features/workflow-builder/components/workflow/primitives/base-node";
import { LabeledHandle } from "@/components/features/workflow-builder/components/workflow/primitives/labeled-handle";
import { useWorkflow } from "@/components/features/workflow-builder/hooks/use-workflow";
import { getUnionOfVariables } from "@/components/features/workflow-builder/lib/workflow/context/variable-resolver";
import type { IfElseNode as IfElseNodeType } from "@/components/features/workflow-builder/lib/workflow/nodes/if-else/if-else.shared";
...
export const IfElseNode = memo(function IfElseNode({ selected, data, deletable, id }: IfElseNodeProps) {
